...
|=======================
|Documents à rendre
|link:rapport/rapport.adoc[rapport]    
|link:rapport/SAES202.xlsx[Grille d'évaluation]       
|=======================
// == Objectives
== Objectifs
...
| 1    | link:src/main/java/iut/sae/algo.java[Efficacite.java]| Java     | Efficacité
| 2    | link:Autres_codes/Efficacite.py[Efficacite.py]    | Python     | Efficacité
| 3    | link:Autres_codes/Simplicite.java[Simplicite.java]           | Java      | Simplicité
| 4    | link:Autres_codes/Sobriete.java[Sobriete.java]           | Java      | Sobriétéé      
|==========================================================================
...
- Java 17+
- Avoir un IDE pour lancer le répertoire
...
- link:https://app.codacy.com/organizations/gh/IUT-Blagnac/dashboard[Codacy]
- link:https://www.youtube.com/watch?v=6vdRvz_LnbQ&t=662s[Tuto installation sonarqube]
- link:https://www.youtube.com/watch?v=AAWNQ2wDVAg[Tuto installation docker]
